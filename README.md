...
> 基于大语言模型的互动叙事运行时，支持结构化剧情推进、实时预览、Fish Speech 兼容 TTS 与郊狼 3.0 本地联动。

[![Docker Image](https://github.com/BobH233/DGLab-AI/actions/workflows/docker-image.yml/badge.svg)](https://github.com/BobH233/DGLab-AI/actions/workflows/docker-image.yml)
[![GHCR](https://img.shields.io/badge/GHCR-ghcr.io%2Fbobh233%2Fdglab--ai-2496ED?logo=docker&logoColor=white)](https://github.com/BobH233/DGLab-AI/pkgs/container/dglab-ai)
